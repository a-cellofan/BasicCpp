/* 
This is decision_making5.cpp file.
It will teach you how to use if-structures and switch statements.
...
int main()
{
    ...
    char c;// here we define a character.
    stringstream iss; // here a define the stringstream type
    srand (time(NULL)); // here start a random seed, using the actual time.

    cout << "Do you want to play to this game, please type y/n (yes or not) and press return" << endl;
    cin >> c;
    switch (c) {
    case 'y':
        cout << "Good!! let's play then" << endl;
        break;
    case 'n':
        cout << "Why are you running this program?"<< endl;
        cout << "bye" << endl;
        return 0;
    default:
        cout << "Oops! somebody make a mistake, I ask you to type y/n (yes or not)" << endl;
        cout << "bye" << endl;
        return 0;
    }
